...
- The "My Data" section had the time I spent on social media in minutes card, which seemed less intuitive to people, so converting it into days made a difference, as that seemed more digestible and easy to estimate, and created a sense of urgency.
- To make my call to action more tangible and valid, I introduced an additional "How do we lower this friction?" section and suggested ways that we could adopt that would help to increase reading and reduce the time spent on social media. This made people think it is not just an idea but something that can be implemented easily in their day-to-day lives.
- Lastly I added a reference section on shorthand.
